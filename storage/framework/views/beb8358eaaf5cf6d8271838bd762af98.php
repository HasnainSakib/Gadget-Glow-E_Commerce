...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', $metaDescription); ?>">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light border-bottom sticky-top py-3 navbar-custom">
        <div class="container-fluid px-3 px-lg-4">
            <a class="navbar-brand d-flex align-items-center gap-2 me-lg-4" href="<?php echo e(route('shop.index')); ?>">
                <?php if($siteLogoUrl): ?>
                    <img src="<?php echo e($siteLogoUrl); ?>" alt="<?php echo e($siteName); ?>" style="max-height: 38px; max-width: 160px; object-fit: contain;">
                <?php else: ?>
                    <img src="<?php echo e($faviconUrl); ?>" alt="<?php echo e($siteName); ?>" style="width: 32px; height: 32px; object-fit: contain;">
                <?php endif; ?>
                <span class="fw-bold text-dark"><?php echo e($siteName); ?></span>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarMain">
                <!-- Search Form -->
                <form action="<?php echo e(route('shop.index')); ?>" method="GET" class="d-flex me-auto my-2 my-lg-0 flex-grow-1" style="max-width: 480px;">
                    <div class="input-group w-100">
                        <input type="text" name="search" class="form-control border-end-0 shadow-sm" placeholder="Search gadgets, makeup, skincare..." value="<?php echo e(request('search')); ?>">
                ...
                <ul class="navbar-nav ms-auto align-items-center gap-1">
                    <li class="nav-item">
                        <a class="nav-link fw-semibold <?php echo e(request()->routeIs('shop.index') ? 'active text-primary' : ''); ?>" href="<?php echo e(route('shop.index')); ?>">
                            <i class="bi bi-shop me-1"></i> Store
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-semibold <?php echo e(request()->routeIs('blog.*') ? 'active text-primary' : ''); ?>" href="<?php echo e(route('blog.index')); ?>">
                            <i class="bi bi-journal-text me-1"></i> Blog
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-semibold <?php echo e(request()->routeIs('about.*') ? 'active text-primary' : ''); ?>" href="<?php echo e(route('about.index')); ?>">
                            <i class="bi bi-info-circle me-1"></i> About Us
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-semibold <?php echo e(request()->routeIs('contact.*') ? 'active text-primary' : ''); ?>" href="<?php echo e(route('contact.index')); ?>">
                            <i class="bi bi-envelope me-1"></i> Contact
                        </a>
                    </li>
                    <li class="nav-item ms-lg-1">
                        <a href="<?php echo e(route('wishlist.index')); ?>" class="btn btn-outline-danger position-relative rounded-pill px-3 py-2 me-1">
                    ...
                    <li class="nav-item ms-lg-1">
                        ...
                        ?>
                        <a href="<?php echo e(route('cart.index')); ?>" class="btn btn-outline-dark position-relative rounded-pill px-3 py-2">
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <h5 class="brand-font text-dark mb-3 d-flex align-items-center gap-2">
                        <img src="<?php echo e($faviconUrl); ?>" style="width: 24px; height: 24px; object-fit: contain;"> Gadget & Glow
                    </h5>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <ul class="list-unstyled small">
                                <li class="mb-2"><a href="<?php echo e(route('shop.index')); ?>" class="text-muted text-decoration-none"><i class="bi bi-chevron-right me-1"></i> Storefront</a></li>
                                <li class="mb-2"><a href="<?php echo e(route('blog.index')); ?>" class="text-muted text-decoration-none"><i class="bi bi-chevron-right me-1"></i> Tech & Beauty Blog</a></li>
                                <li class="mb-2"><a href="<?php echo e(route('about.index')); ?>" class="text-muted text-decoration-none"><i class="bi bi-chevron-right me-1"></i> About Us</a></li>
                            </ul>
                        </div>
                        <div class="col-6">
                            <ul class="list-unstyled small">
                                <li class="mb-2"><a href="<?php echo e(route('contact.index')); ?>" class="text-muted text-decoration-none"><i class="bi bi-chevron-right me-1"></i> Contact Us</a></li>
                                <li class="mb-2"><a href="<?php echo e(route('cart.index')); ?>" class="text-muted text-decoration-none"><i class="bi bi-chevron-right me-1"></i> View Cart</a></li>
                                <li class="mb-2"><a href="<?php echo e(route('wishlist.index')); ?>" class="text-muted text-decoration-none"><i class="bi bi-chevron-right me-1"></i> Wishlist</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <a href="<?php echo e(route('contact.index')); ?>" class="btn btn-outline-dark btn-sm rounded-pill px-3">Contact Support <i class="bi bi-arrow-right ms-1"></i></a>
                </div>
            </div>
            <hr class="border-secondary my-4 opacity-25">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center small text-muted">
                <div>&copy; <?php echo e(date('Y')); ?> Gadget & Glow Store. Built with Laravel & Bootstrap 5.</div>
...
<?php /**PATH C:\Users\monom\Downloads\gadget-glow-store\resources\views/layouts/app.blade.php ENDPATH**/ ?>