...
<body>
    ...
    <div class="login-card text-center">
        ...
        <?php if(session('success')): ?>
            <div class="alert alert-success border-0 rounded-3 p-3 mb-4 text-start small" style="background: rgba(16, 185, 129, 0.15); color: #6ee7b7; border: 1px solid rgba(16, 185, 129, 0.3) !important;">
                <i class="bi bi-check-circle-fill me-1"></i> <?php echo e(session('success')); ?>

            </div>
        <?php endif; ?>

        <form action="<?php echo e(route('admin.login.submit')); ?>" method="POST" class="text-start">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="login" id="login" class="form-control ps-2" placeholder="admin@gadgetglow.com" value="<?php echo e(old('login', 'admin@gadgetglow.com')); ?>" required autofocus>
                </div>
            </div>
...
<?php /**PATH C:\Users\monom\Downloads\gadget-glow-store\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>