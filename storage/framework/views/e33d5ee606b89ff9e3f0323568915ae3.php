<?php $__env->startSection('title', 'Gadget & Glow - Premium Tech & Beauty Collection'); ?>
                            ...
                            <div class="row align-items-center w-100 g-4">
                                <div class="col-md-7">
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        ...
                                        <a href="<?php echo e(route('about.index')); ?>" class="btn btn-outline-dark btn-lg rounded-pill px-4">
                                            Learn More
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="hero-banner p-4 p-md-5 d-flex align-items-center" style="min-height: 380px; background: linear-gradient(135deg, #eff6ff 0%, #ffffff 50%, #f0fdf4 100%);">
                            <div class="row align-items-center w-100 g-4">
                                <div class="col-md-7">
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        <a href="<?php echo e(route('shop.category', 'tech-gadgets')); ?>" class="btn btn-primary-custom btn-lg rounded-pill fw-bold px-4 shadow-sm">
                        ...
                        <div class="hero-banner p-4 p-md-5 d-flex align-items-center" style="min-height: 380px; background: linear-gradient(135deg, #fdf2f8 0%, #ffffff 50%, #fff7ed 100%);">
                            <div class="row align-items-center w-100 g-4">
                                <div class="col-md-7">
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        <a href="<?php echo e(route('shop.category', 'beauty-makeup')); ?>" class="btn btn-accent btn-lg rounded-pill fw-bold px-4 shadow-sm">
                ...
                <div class="row g-3">
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-6 col-md-4 col-xl-3">
                            <a href="<?php echo e(route('shop.category', $category->slug)); ?>" class="text-decoration-none">
                                <div class="card h-100 border-0 shadow-sm p-3 text-center rounded-4 hover-lift" style="background: #ffffff; transition: transform 0.2s;">
                                    <div class="rounded-circle d-flex align-items-center justify-content-center mx-auto mb-2" style="width: 54px; height: 54px; background: <?php echo e($category->slug == 'tech-gadgets' ? '#eff6ff' : '#fdf2f8'); ?>; color: <?php echo e($category->slug == 'tech-gadgets' ? '#2563eb' : '#db2777'); ?>;">
                                        <i class="bi <?php echo e($category->slug == 'tech-gadgets' ? 'bi-laptop fs-4' : 'bi-flower1 fs-4'); ?>"></i>
                                    </div>
                                    <h6 class="fw-bold text-dark mb-1"><?php echo e($category->name); ?></h6>
                                    <span class="text-muted small"><?php echo e($category->products_count); ?> Products</span>
                                </div>
                            </a>
                        </div>
            ...
            <div class="sticky-top" style="top: 90px; z-index: 10;">
                ...
                <div class="card p-3 mb-4 border-0 shadow-sm bg-white rounded-4">
                    ...
                    <div id="bestSellersWrapper" class="horizontal-slider-wrapper py-1">
                        <div class="d-flex gap-2">
                            <?php $__currentLoopData = $bestSellers->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="horizontal-card-item sidebar-slider-item flex-shrink-0">
                                    <div class="sidebar-product-card p-2 rounded-3 d-flex flex-column h-100" style="border: 1px solid #eae4d8; background: #ffffff;">
                                        <a href="<?php echo e(route('shop.show', $item->slug)); ?>" class="mb-2 text-center overflow-hidden rounded-3 bg-light d-block" style="height: 95px;">
                                            <img src="<?php echo e($item->image); ?>" alt="<?php echo e($item->name); ?>" class="img-fluid h-100 w-100" style="object-fit: cover;" onerror="this.onerror=null; this.src='data:image/svg+xml;utf8,<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'600\' height=\'600\' viewBox=\'0 0 600 600\'><rect width=\'100%\' height=\'100%\' fill=\'%23faf7f2\'/><text x=\'50%\' y=\'50%\' dominant-baseline=\'middle\' text-anchor=\'middle\' font-size=\'24\' fill=\'%2378716c\'>Item</text></svg>';">
                                        </a>
                                        <span class="badge-category <?php echo e($item->category && $item->category->slug == 'tech-gadgets' ? 'badge-gadget' : 'badge-beauty'); ?> mb-1 d-inline-block text-truncate" style="font-size: 0.55rem; padding: 0.15em 0.35em; max-width: 100%;">
                                            <?php echo e($item->category ? $item->category->name : 'Item'); ?>

                                        </span>
                                        <h6 class="fw-bold text-dark text-truncate mb-1" style="font-size: 0.78rem;" title="<?php echo e($item->name); ?>">
                                            <a href="<?php echo e(route('shop.show', $item->slug)); ?>" class="text-decoration-none text-dark hover-primary"><?php echo e($item->name); ?></a>
                                        </h6>
                                        <div class="d-flex align-items-center justify-content-between mt-auto pt-1 border-top">
                                            <span class="fw-bold text-primary" style="font-size: 0.8rem;">৳<?php echo e(number_format($item->price, 0)); ?></span>
                                            <form action="<?php echo e(route('cart.add', $item->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" class="btn btn-primary-custom rounded-circle p-0 d-flex align-items-center justify-content-center shadow-sm" style="width: 24px; height: 24px;" title="Add to Cart" <?php echo e($item->stock <= 0 ? 'disabled' : ''); ?>>
                ...
                <div class="card p-3 mb-4 border-0 shadow-sm bg-white rounded-4">
                    ...
                    <div id="newArrivalsWrapper" class="horizontal-slider-wrapper py-1">
                        <div class="d-flex gap-2">
                            <?php $__currentLoopData = $newArrivals->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $new): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="horizontal-card-item sidebar-slider-item flex-shrink-0">
                                    <div class="sidebar-product-card p-2 rounded-3 d-flex flex-column h-100" style="border: 1px solid #eae4d8; background: #ffffff;">
                                        <a href="<?php echo e(route('shop.show', $new->slug)); ?>" class="mb-2 text-center overflow-hidden rounded-3 bg-light d-block" style="height: 95px;">
                                            <img src="<?php echo e($new->image); ?>" alt="<?php echo e($new->name); ?>" class="img-fluid h-100 w-100" style="object-fit: cover;" onerror="this.onerror=null; this.src='data:image/svg+xml;utf8,<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'600\' height=\'600\' viewBox=\'0 0 600 600\'><rect width=\'100%\' height=\'100%\' fill=\'%23faf7f2\'/><text x=\'50%\' y=\'50%\' dominant-baseline=\'middle\' text-anchor=\'middle\' font-size=\'24\' fill=\'%2378716c\'>Item</text></svg>';">
                                        </a>
                                        <span class="badge-category <?php echo e($new->category && $new->category->slug == 'tech-gadgets' ? 'badge-gadget' : 'badge-beauty'); ?> mb-1 d-inline-block text-truncate" style="font-size: 0.55rem; padding: 0.15em 0.35em; max-width: 100%;">
                                            <?php echo e($new->category ? $new->category->name : 'Item'); ?>

                                        </span>
                                        <h6 class="fw-bold text-dark text-truncate mb-1" style="font-size: 0.78rem;" title="<?php echo e($new->name); ?>">
                                            <a href="<?php echo e(route('shop.show', $new->slug)); ?>" class="text-decoration-none text-dark hover-primary"><?php echo e($new->name); ?></a>
                                        </h6>
                                        <div class="d-flex align-items-center justify-content-between mt-auto pt-1 border-top">
                                            <span class="fw-bold text-success" style="font-size: 0.8rem;">৳<?php echo e(number_format($new->price, 0)); ?></span>
                                            <form action="<?php echo e(route('cart.add', $new->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" class="btn btn-primary-custom rounded-circle p-0 d-flex align-items-center justify-content-center shadow-sm" style="width: 24px; height: 24px;" title="Add to Cart" <?php echo e($new->stock <= 0 ? 'disabled' : ''); ?>>
                                                    <i class="bi bi-bag-plus-fill" style="font-size: 0.65rem;"></i>
                                                </button>
                                            </form>
                                        </div>
        ...
        <?php if($category->products && $category->products->count() > 0): ?>
            <div class="mb-5 pt-3 border-top">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div>
                        <h4 class="fw-bold mb-1 text-dark d-flex align-items-center gap-2">
                            <?php if($category->slug == 'tech-gadgets'): ?>
                                <i class="bi bi-laptop text-primary"></i>
                            <?php else: ?>
                                <i class="bi bi-flower1 text-pink" style="color: #ec4899;"></i>
                            <?php endif; ?>
                            <?php echo e($category->name); ?> Showcase
                        </h4>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="d-flex align-items-center gap-1 me-1">
                            <button type="button" class="btn btn-sm btn-light border rounded-circle p-0 d-flex align-items-center justify-content-center shadow-sm" style="width: 34px; height: 34px;" onclick="slideHorizontal('cat_slider_<?php echo e($category->id); ?>', -1)" title="Previous">
                                <i class="bi bi-chevron-left" style="font-size: 0.9rem;"></i>
                            </button>
                            <button type="button" class="btn btn-sm btn-primary rounded-circle p-0 d-flex align-items-center justify-content-center shadow-sm" style="width: 34px; height: 34px;" onclick="slideHorizontal('cat_slider_<?php echo e($category->id); ?>', 1)" title="Next">
                                <i class="bi bi-chevron-right" style="font-size: 0.9rem;"></i>
                            </button>
                        </div>
                        <a href="<?php echo e(route('shop.category', $category->slug)); ?>" class="btn btn-outline-dark rounded-pill btn-sm px-3 fw-bold">
                            View All (<?php echo e($category->products_count); ?>) <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
                </div>

                <!-- Horizontal Slider Wrapper for Category Items -->
                <div id="cat_slider_<?php echo e($category->id); ?>" class="horizontal-slider-wrapper py-2" style="overflow-x: hidden; scroll-behavior: smooth;">
                    <div class="d-flex gap-3">
                        <?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="horizontal-card-item flex-shrink-0" style="width: calc(25% - 0.75rem); min-width: 250px;">
                                <div class="card product-card h-100 border-0 shadow-sm rounded-4 bg-white">
                                    <div class="position-relative overflow-hidden" style="height: 180px;">
                                        <a href="<?php echo e(route('shop.show', $catProduct->slug)); ?>">
                                            <img src="<?php echo e($catProduct->image); ?>" class="card-img-top h-100 w-100" alt="<?php echo e($catProduct->name); ?>" style="object-fit: cover;" onerror="this.onerror=null; this.src='data:image/svg+xml;utf8,<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'600\' height=\'600\' viewBox=\'0 0 600 600\'><rect width=\'100%\' height=\'100%\' fill=\'%23faf7f2\'/><text x=\'50%\' y=\'50%\' dominant-baseline=\'middle\' text-anchor=\'middle\' font-size=\'24\' fill=\'%2378716c\'>Product</text></svg>';">
                                        </a>
                                    ...
                                    <div class="card-body d-flex flex-column p-3">
                                        <h6 class="card-title fw-bold text-dark mb-1 text-truncate" title="<?php echo e($catProduct->name); ?>">
                                            <a href="<?php echo e(route('shop.show', $catProduct->slug)); ?>" class="text-decoration-none text-dark hover-primary">
                                        ...
                                        <p class="card-text text-muted small mb-2 flex-grow-1" style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; font-size: 0.8rem;">
                                            <?php echo e($catProduct->description); ?>

                                        </p>
                                        <div class="d-flex align-items-center justify-content-between mt-auto pt-2 border-top">
                                            <div>
                                                <span class="fs-6 fw-bold text-primary">৳<?php echo e(number_format($catProduct->price, 0)); ?></span>
                                            </div>
                                            <form action="<?php echo e(route('cart.add', $catProduct->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" class="btn btn-primary-custom rounded-circle p-2 d-flex align-items-center justify-content-center" style="width: 34px; height: 34px;" title="Add to Cart" <?php echo e($catProduct->stock <= 0 ? 'disabled' : ''); ?>>
    ...
    <div id="products-catalog" class="pt-4 pb-5 my-4 border-top">
        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4">
            <div>
                ...
                <h3 class="fw-extrabold mb-1 text-dark">
                    <?php if(request('category')): ?>
                        ...
                        ?>
                        Showing Products under: <span class="text-primary"><?php echo e($activeCategory ? $activeCategory->name : ucfirst(request('category'))); ?></span>
            ...
            <div class="d-flex align-items-center gap-2">
                <?php if(request('category') || request('search')): ?>
                    <a href="<?php echo e(route('shop.index')); ?>#products-catalog" class="btn btn-sm btn-outline-danger rounded-pill px-3 fw-bold">
            ...
            <div class="row align-items-center g-3">
                <div class="col-lg-7">
                    <div class="d-flex flex-wrap gap-2">
                        <a href="<?php echo e(route('shop.index')); ?>#products-catalog" class="btn btn-sm <?php echo e(!request('category') ? 'btn-primary-custom fw-bold shadow-sm' : 'btn-outline-dark'); ?> rounded-pill px-3">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <a href="<?php echo e(route('shop.index', ['category' => $cat->slug])); ?>#products-catalog" class="btn btn-sm <?php echo e($isActive ? 'btn-primary-custom fw-bold shadow-sm' : 'btn-outline-dark'); ?> rounded-pill px-3">
                ...
                <div class="col-lg-5">
                    <form action="<?php echo e(route('shop.index')); ?>" method="GET" class="d-flex gap-2">
                        <?php if(request('category')): ?>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="search" class="form-control bg-light border-start-0 ps-0" placeholder="Search gadgets, makeup..." value="<?php echo e(request('search')); ?>">
                    ...
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="card product-card h-100 border-0 shadow-sm rounded-4 bg-white">
                            <div class="position-relative overflow-hidden" style="height: 200px;">
                                ...
                                <div class="position-absolute top-0 start-0 m-2">
                                    <span class="badge-category <?php echo e($product->category && $product->category->slug == 'tech-gadgets' ? 'badge-gadget' : 'badge-beauty'); ?>">
                                        <?php echo e($product->category ? $product->category->name : 'General'); ?>

                                    </span>
                                </div>
                                <div class="position-absolute top-0 end-0 m-2">
                                    <button type="button" class="btn btn-sm btn-light rounded-circle shadow-sm p-0 d-flex align-items-center justify-content-center text-danger" style="width: 32px; height: 32px;" data-bs-toggle="modal" data-bs-target="#wishlistModalCat<?php echo e($product->id); ?>" title="Add to Wishlist">
                            ...
                            <div class="modal fade" id="wishlistModalCat<?php echo e($product->id); ?>" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="card-body d-flex flex-column p-3">
                                <h6 class="card-title fw-bold text-dark mb-1 text-truncate" title="<?php echo e($product->name); ?>">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-auto pt-2 border-top">
                                    ...
                                    <div class="d-flex align-items-center gap-1">
                                        <form action="<?php echo e(route('cart.add', $product->id)); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" class="btn btn-primary-custom rounded-circle p-2 d-flex align-items-center justify-content-center" style="width: 34px; height: 34px;" title="Add to Cart" <?php echo e($product->stock <= 0 ? 'disabled' : ''); ?>>
                                                <i class="bi bi-bag-plus-fill fs-6"></i>
                                            </button>
                                        </form>
        ...
        <?php else: ?>
            <div class="text-center py-5 bg-white rounded-4 shadow-sm border">
                ...
                <a href="<?php echo e(route('shop.index')); ?>#products-catalog" class="btn btn-primary-custom rounded-pill px-4">View All Products</a>
            </div>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\monom\Downloads\gadget-glow-store\resources\views/shop/index.blade.php ENDPATH**/ ?>