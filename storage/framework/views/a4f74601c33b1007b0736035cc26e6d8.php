...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <p style="font-size: 16px; font-weight: 700; color: #0f172a;">প্রিয় <?php echo e($customerName); ?>,</p>
            ...
            <div class="product-card">
                <img src="<?php echo e($product->image); ?>" alt="<?php echo e($product->name); ?>" class="product-img">
                ...
                <div style="margin-top: 15px;">
                    <a href="<?php echo e(route('shop.show', $product->slug)); ?>" class="btn-order">
...
<?php /**PATH C:\Users\monom\Downloads\gadget-glow-store\resources\views/emails/product_restocked.blade.php ENDPATH**/ ?>