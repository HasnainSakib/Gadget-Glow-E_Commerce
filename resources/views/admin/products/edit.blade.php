...
<div class="card border-0 shadow-sm rounded-4 p-4 p-md-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
        <h5 class="fw-bold mb-0">Edit Product #{{ $product->id }}</h5>
    ...
    <form action="{{ route('admin.products.update', $product->id) }}" method="POST">
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-6">
                ...
                <input type="number" step="1" name="price" id="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price', (int)$product->price) }}" required>
        ...
        <div class="mb-3">
            ...
            <input type="url" name="image" id="image" class="form-control @error('image') is-invalid @enderror" value="{{ old('image', $product->image) }}" required>
