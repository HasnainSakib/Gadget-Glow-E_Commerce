...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <p style="font-size: 16px; font-weight: 700; color: #0f172a;">প্রিয় {{ $order->customer_name }},</p>
            ...
            <table class="info-table">
                ...
                <tr>
                    ...
                    <td class="value"><span class="badge-ref">{{ $order->payment_ref_code }}</span></td>
                </tr>
                @endif
                <tr>
                    <td class="label">ডেলিভারি ঠিকানা:</td>
                    <td class="value" style="font-weight: 500;">{{ $order->shipping_address }}</td>
                </tr>
            </table>
            ...
            <div style="background-color: #fffbeb; border: 1px solid #fef3c7; padding: 12px 15px; border-radius: 8px; font-size: 13px; color: #92400e;">
                ...
                @endif
                <br>
                তথা লেনদেনের সময় <code>{{ $order->payment_ref_code }}</code> কোডটি রেফারেন্স হিসেবে ব্যবহার করার জন্য অনুরোধ করা হলো।
            </div>
            @endif
        </div>
