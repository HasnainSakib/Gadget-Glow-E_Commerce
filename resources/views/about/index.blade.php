...
@section('title', 'About Us - Gadget & Glow')
...
<div class="container py-4">
    ...
    <div class="hero-banner mb-5 text-center position-relative">
        ...
        <h1 class="display-4 fw-bold mb-3 text-dark">{{ $about->hero_title }}</h1>
    ...
    <div class="row align-items-center g-5 mb-5">
        <div class="col-lg-6">
            <div class="position-relative">
                <img src="{{ Str::startsWith($about->hero_image, ['http://', 'https://']) ? $about->hero_image : asset($about->hero_image) }}" alt="About Gadget & Glow" class="img-fluid rounded-4 shadow-sm w-100 border" style="min-height: 380px; object-fit: cover;" onerror="this.onerror=null; this.src='data:image/svg+xml;utf8,<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'600\' height=\'600\' viewBox=\'0 0 600 600\'><rect width=\'100%\' height=\'100%\' fill=\'%23faf7f2\'/><text x=\'50%\' y=\'50%\' dominant-baseline=\'middle\' text-anchor=\'middle\' font-size=\'24\' fill=\'%2378716c\'>About Us</text></svg>';">
        ...
        <div class="col-lg-6">
            <div class="ps-lg-3">
                ...
                <h2 class="fw-bold display-6 mb-3 text-dark brand-font">{{ $about->story_title }}</h2>
        ...
        <div class="card-body p-5">
            <div class="row text-center g-4">
                <div class="col-6 col-md-3">
                    <h2 class="display-5 fw-bold text-primary mb-1">{{ $about->stat_1_number }}</h2>
                    <p class="text-muted mb-0 fw-semibold">{{ $about->stat_1_label }}</p>
                </div>
                <div class="col-6 col-md-3">
                    <h2 class="display-5 fw-bold text-danger mb-1">{{ $about->stat_2_number }}</h2>
                    <p class="text-muted mb-0 fw-semibold">{{ $about->stat_2_label }}</p>
                </div>
                <div class="col-6 col-md-3">
                    <h2 class="display-5 fw-bold text-warning mb-1">{{ $about->stat_3_number }}</h2>
                    <p class="text-muted mb-0 fw-semibold">{{ $about->stat_3_label }}</p>
                </div>
                <div class="col-6 col-md-3">
                    <h2 class="display-5 fw-bold text-info mb-1">{{ $about->stat_4_number }}</h2>
                    <p class="text-muted mb-0 fw-semibold">{{ $about->stat_4_label }}</p>
                </div>
            </div>
        </div>
    </div>
